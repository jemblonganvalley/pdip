...
const CardBeritaFoto = ({ pemilu16, pemilu17, title, paragraph1, paragraph2 }) => {
    return (
        <>
            {/* Column5 */}
            <div className="wrapper-cardBerFoto">
                ...
                <div className="row1-col5-cardBerFoto">
                    <img src={pemilu16} className="box-img">
                ...
                <Link to='/page2' className="row2-col5-cardBerFoto">
                    {/* Column1 */}
                    <img src={pemilu17} className="col1-row2-cardBerFoto">

                    </img>
                    {/* END Column1 */}
                    {/* Column2 */}
                    <div className="col2-row2-cardBerFoto">
                        <h5 className="txt-jdl-col2">
                            {paragraph1}
                        </h5>
