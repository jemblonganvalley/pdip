...
const CardInformasi = ({image, image2, image3, image4, text, text2, text3, text4, to1, to2, to3, to4, width1, width2, width3, width4, paddingBottom, bgColor1, color1, hover1})=> {
    return (
