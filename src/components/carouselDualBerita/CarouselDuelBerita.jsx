            ...
            <div className="carousel-inner">
                ...
                {cat1.map((e,i)=>(
                    <div className={`carousel-item ${i == 1 && 'active'}`}>
                        ...
                        <img src={`https://atur.biar.pw/public/${e.image}`} className="d-block w-100 carouselDual1Image" alt="..." key={i} style={{
                            width : '100%',
                            height : '40vh',
                            objectFit : 'cover',
                 ...
                 {cat2.map((e,i)=>(
                    <div className={`carousel-item ${i == 1 && 'active'}`}>
                        <span className='carouselDual_title' style={{
                            ...
                            {/* <small style={{padding : '0'}}>{e.author}</small> | &nbsp; */}
                            <small style={{padding : '0'}} dangerouslySetInnerHTML={{__html : e.description}}></small>
                            <h4>{e.title}</h4>
                        ...
                        <img src={e.type === 'youtube' ? `https://i.ytimg.com/vi/${e.path}/hqdefault.jpg` : `https://atur.biar.pw/public/${e.path}`} className="d-block w-100 carouselDual1Image" alt="..." key={i} style={{
                            width : '100%',
                            height : '40vh',
                            objectFit : 'cover',
                            objectPosition : 'center',
