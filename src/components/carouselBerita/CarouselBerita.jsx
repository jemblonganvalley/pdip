...
const CarouselBerita = ({ data }) => {
  return (
    <React.Fragment>
      <div
        id="beritaPage"
        className="carousel container-carousel-beritaPage slide"
        data-ride="carousel"
      >
            ...
            <div className="col1-container-1-beritaPage">
              <div className="cont-img-col1-beritaPage">
                ...
                <div className="col2-img-beritaPage">
                  <div className="garis-strip-col2-beritaPage"></div>
                  <div className="box-txt-desk-col2-beritaPage">
                    ...
                    <p className="txt-desk-col2-beritaPage">
                      ...
                      Similique quidem ad iure harum optio corporis eligendi
                      amet vitae dolor enim? Molestiae magnam voluptas fuga quo
                      dolores harum dignissimos autem sint distinctio maiores
                      quasi nemo reprehenderit maxime sunt quaerat, aliquam
                      eligendi quas consequuntur delectus nulla eius ex,
                      aspernatur quisquam. Error, voluptatibus.
                    </p>
                  </div>
                </div>
              </div>
